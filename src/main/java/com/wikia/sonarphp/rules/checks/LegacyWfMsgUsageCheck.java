...
public class LegacyWfMsgUsageCheck extends PHPVisitorCheck {
	private final static String MESSAGE = "Replace this legacy wfMsg* function call with one of the new i18n functions.";
	private final static String WF_MSG = "wfMsg";
